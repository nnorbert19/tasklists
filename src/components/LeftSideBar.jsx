        ...
        <div className='drawer-side'>
          ...
          <ul className='menu p-4 w-60 min-h-full bg-primary text-base-content'>
            ...
            <div className='flex justify-start items-center flex-col'>
              ...
              <a
                onClick={() => logout()}
                className={`mt-[auto]  w-full flex flex-row items-center gap-x-4 hover:bg-secondary-focus rounded-md cursor-pointer`}
              >
                <span className='block float-left'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
...
/*<div
        className={`fixed top-0 left-0 bg-primary h-screen  pt-8 w-60 p-5 z-50 duration-500 ease-linear `}
      >
        ...
        <div className=' h-full flex justify-start items-center flex-col overflow-hidden'>
          <div
            className={`${isOpen ? 'w-24' : 'w-10'} duration-500 ease-in-out`}
          >
            <Link href={'/profil'}>
              <Avatar photoUrl={user?.photoURL} />
            </Link>
